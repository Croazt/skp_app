...
class DetailKinerjaUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        $rules['detail_rencana'] = [ 'required', 'string', Rule::unique('detail_kinerja','deskripsi')->ignore(request()->detail_rencana,'deskripsi')];
