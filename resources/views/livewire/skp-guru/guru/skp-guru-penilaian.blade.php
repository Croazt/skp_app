    ...
    <div id="accordion">
        <div class="card tw-px-0">
            ...
            <div class="card-header tw-py-0 collapsible" href="#collapseOneRencana" data-toggle="collapse"
                data-target="#collapseOneRencana" aria-expanded="true" id="headingOne" aria-controls="collapseOneRencana" wire:ignore>
            ...
            <div id="collapseOneRencana" class="collapse show" aria-labelledby="headingOne" 
                wire:ignore.self>
                    ...
                    <div class="table-responsive table-scroll" id='rencana-table'>
                        <table class="table table-bordered datatable-sortable table-sm tw-text-sm table-complex">
                            <thead class="text-center">
                                <tr>
                                    {!! $this->renderHeader('RENCANA KINERJA ATASAN LANGSUNG/ UNIT KERJA DAN ATAU ORGANISASI YANG DIINTERVENSI','',2,1) !!}
            ...
            <div class="card-header tw-py-0 collapsible" id="headingTwo" href="#collapseTwoRencana" data-toggle="collapse"
                data-target="#collapseTwoRencana" aria-expanded="true" aria-controls="collapseTwoRencana" wire:ignore>
                <div class="tw-w-full tw-flex tw-justify-between">
                    <span
                        class="tw-my-auto tw-text-center tw-text-base tw-font-extrabold tw-cursor-pointer tw-select-none">
                        KINERJA TAMBAHAN
            ...
            <div id="collapseTwoRencana" class="collapse show" aria-labelledby="headingTwo" 
                wire:ignore.self>
                <div class="card-body px-0 tw-pt-0">
                    <div class="table-responsive table-scroll" id='rencana-table'>
                        <table class="table table-bordered datatable-sortable table-sm tw-text-sm table-complex">
