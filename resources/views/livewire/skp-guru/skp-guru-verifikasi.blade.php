<div>
    ...
    <div id="accordion">
        <div class="card tw-px-0">
            <div class="card-header tw-py-0 collapsible" href="#collapseOneVerifikasi" data-toggle="collapse"
                data-target="#collapseOneVerifikasi" aria-expanded="true" id="headingOne"
                aria-controls="collapseOneVerifikasi" wire:ignore>
            ...
            <div id="collapseOneVerifikasi" class="collapse show" aria-labelledby="headingOne" wire:ignore.self>
                        ...
                        <table class="table table-bordered datatable-sortable table-sm tw-text-sm table-complex">
                            ...
                            @foreach ($this->rencanaKinerjaUtama as $rencanaKinerja)
                                @if ($this->skpGuru->status == 'reviu')
                                    @include('livewire.skp-guru.tables.verifikasi')
                                @else
            ...
            <div class="card-header tw-py-0 collapsible" id="headingTwo" href="#collapseTwoVerifikasi"
                data-toggle="collapse" data-target="#collapseTwoVerifikasi" aria-expanded="true"
                aria-controls="collapseTwoVerifikasi" wire:ignore>
                <div class="tw-w-full tw-flex tw-justify-between">
                    <span
                        class="tw-my-auto tw-text-center tw-text-base tw-font-extrabold tw-cursor-pointer tw-select-none">
                        KINERJA TAMBAHAN
            ...
            <div id="collapseTwoVerifikasi" class="collapse show" aria-labelledby="headingTwo" wire:ignore.self>
                <div class="card-body px-0 tw-pt-0">
                    <div class="table-responsive table-scroll" id='peta-table'>
                        <table class="table table-bordered datatable-sortable table-sm tw-text-sm table-complex">
                            <thead class="text-center">
    ...
    @if ($this->skpGuru->status == 'reviu')
        <div class="tw-w-full tw-text-center">
            <button type='button' class="btn btn-primary tw-text-cent3er" wire:click='verifikasiSKP'>Verifikasi Rencana
                SKP</button>
        </div>
    @endif
    {{-- @push('scripts') --}}
