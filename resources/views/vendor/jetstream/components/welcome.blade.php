<div class="tw-p-6 sm:tw-px-20 tw-bg-white tw-border-b tw-border-gray-200">
    <div>
        <x-jet-application-logo class="tw-block tw-h-12 tw-w-auto" />
    </div>
    ...
    <div class="tw-p-6">
        <div class="tw-flex tw-items-center">
            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                viewBox="0 0 24 24" class="tw-w-8 tw-h-8 tw-text-gray-400">
                <path
                    d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253">
                </path>
            </svg>
            <div class="tw-ml-4 tw-text-lg tw-text-gray-600 tw-leading-7 tw-font-semibold"><a
